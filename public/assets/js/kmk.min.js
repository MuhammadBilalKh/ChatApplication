...
! function(e) {
var kmk_data = {
    mobile_logo_url: "path_to_mobile_logo.png",   
    default_logo_url: "path_to_default_logo.png", 
    kmk_search_nonce: "your_nonce_value",          
    ajaxurl: "/path/to/your/ajax-handler",         
    more_text: "More",                            
    icon_logo_url: "http://localhost/Client/social-media/assets/images/logo.png",        
    fire_login_modal: true,                        
    bp_is_active: true,                         
    stick_offset: 90,                              
};
    ...
    const a = e("body.kmk"),
        ...
        n = e("#kmk-page"),
        o = e(".kmk-preloader"),
        s = e("#kmk-social-panel .panel-logo img").attr("src"),
        r = e(".kmk-navbar .default-logo").attr("src");
    ...
    if (i.hasClass("default")) {
        ...
        a.hasClass("desktop-slidenav") ? t.hiraku({
            btn: ".kmk-navbar.default .kmk-toggler",
            direction: "right"
        }) : (t.hiraku({
            btn: ".kmk-navbar.default .kmk-toggler",
            direction: "right",
    ...
    if (i.hasClass("social")) {
        ({
            ...
            ajaxRequest: function(a) {
                ...
                if (!0 === i) return;
                let n = this.results,
                    o = this.form.find(".kmk-loading-ring");
                e.ajax({
                    type: "POST",
                    data: {
                        action: "kmk_ajax_search",
                        search: t,
                        search_nonce: kmk_data.kmk_search_nonce
                    },
                    datatype: "json",
                    url: kmk_data.ajaxurl,
                    beforeSend: function() {
                        o.show(), i = !0
                    },
                    success: function(e) {
    ...
    function p() {
        ...
        (t.length || i.length) && (window.innerWidth > 991.98 ? a.hasClass("kmk-social-layout") ? 
        (t.stick_in_parent({
            offset_top: Number(kmk_data.stick_offset),
            bottoming: !1
        }), i.stick_in_parent({
            offset_top: t.outerHeight(!0) + Number(kmk_data.stick_offset),
            bottoming: !1
        }), 90 == kmk_data.stick_offset && e(window).on("scroll", function() {
            "fixed" == t.css("position") && parseFloat(t.css("top")) < kmk_data.stick_offset && (t.css("top", kmk_data.stick_offset + "px"), i.css("top", t.outerHeight(!0) + Number(kmk_data.stick_offset) + "px"))
        })) : (t.stick_in_parent({
            offset_top: Number(kmk_data.stick_offset)
    ...
    function b() {
        const t = e("#kmk-social-panel .panel-logo img");
        a.hasClass("panel-expanded") && (window.innerWidth < 1199.98 ? a.addClass("panel-collapsed") : window.innerWidth > 1920.98 ? a.addClass("panel-collapsed") : a.removeClass("panel-collapsed")), window.innerWidth > 767.98 ? s && kmk_data.icon_logo_url && (a.hasClass("panel-collapsed") ? t.attr("src") !== kmk_data.icon_logo_url && t.attr("src", kmk_data.icon_logo_url) : t.attr("src") !== s && t.attr("src", s)) : t.attr("src") !== s && t.attr("src", s)
    }

    function f() {
        if (kmk_data.bp_is_active && a.hasClass("logged-in") && a.hasClass("kmk-social-layout") && i.hasClass("social")) {
            if (!e("ul#navbar-user").length) return;
            !e("nav.kmk-navbar button.account-toggler").length && i.hasClass("social") && e("nav.kmk-navbar > div").prepend(e("<button>").addClass("kmk-toggler account-toggler").attr("type", "button").append(kmk_data.avatar)), e("#navbar-account-sidebar").length || n.after('<div id="navbar-account-sidebar"></div>');
            ...
            if (window.innerWidth < 767.98) {
                if (!e("#navbar-account-sidebar ul.member-account-menu").length) {
                    if (t.addClass("mobile-header"), o.addClass("navbar-account-sidebar").append(s.find("ul.member-account-menu")), s.hide(), !e(".nav-top-bar").length) {
                        const a = e("nav.kmk-navbar > div");
                        a.prepend('<div class="nav-top-bar"></div>'), e(".nav-top-bar").append(a.find("button.account-toggler")).append(a.find("button.panel-toggler")).append(a.find("#kmk-ajax-search"))
    ...
    function v() {
        const a = e(".kmk-navbar .default-logo");
        a.length && kmk_data.mobile_logo_url && (window.innerWidth < 768 ? a.attr("src", kmk_data.mobile_logo_url) : a.attr("src") !== r && a.attr("src", r))
    }
    a.hasClass("kmk-social-layout") && (b(), e(window).on("resize", b), i.hasClass("social") && e("nav.kmk-navbar > div").prepend(e("<button>").addClass("kmk-toggler panel-toggler").attr("type", "button").append('<span class="icon-bar bar1"></span>').append('<span class="icon-bar bar2"></span>').append('<span class="icon-bar bar3"></span>')), e("#kmk-social-panel").hiraku({
        btn: ".panel-toggler",
        direction: "left",
        breakpoint: 767.98
        ...
        direction: "right",
        breakpoint: 767.98
    }), window.innerWidth < 767.98 && (e("#kmk-page + .js-hiraku-offcanvas").hasClass("js-hiraku-offcanvas-active") || e("#kmk-page + .js-hiraku-offcanvas").addClass("js-hiraku-offcanvas-active")), a.hasClass("panel-collapsed") && e(".panel-icon-only ul.navbar-panel li a").each(function() {
        e(this).attr("title", e(this).text())
    })), e(window).on("load resize", function() {
        clearTimeout(h), h = setTimeout(p, 500)
    }), kmk_data.fire_login_modal && e(window).on("load", function() {
