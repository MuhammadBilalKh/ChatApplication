...
class WPAdverts_Block_Single_Gallery {
    ...
    constructor(gallery) {
        ...
        this.nav = gallery.querySelector(".kmk-block-gallery-nav");
        this.nav_container = gallery.querySelector(".kmk-block-gallery-nav-container");
        this.nav_left = gallery.querySelector(".kmk-block-gallery-nav-left");
        this.nav_left_btn = gallery.querySelector(".kmk-block-gallery-nav-left-btn");
        this.nav_right = gallery.querySelector(".kmk-block-gallery-nav-right");
        this.nav_right_btn = gallery.querySelector(".kmk-block-gallery-nav-right-btn");
        this.nav_items = gallery.querySelectorAll(".kmk-block-gallery-nav-item");
        ...
        this.slider = tns({
            container: ".kmk-block-gallery-slider",
            items: 1,
            slideBy: 1,
            autoplay: false,
            mouseDrag: true,
            ...
            controls: false,
            nav: false,
            lazyload: this.gallery.querySelector(".kmk-block-gallery-slider").classList.contains("wpa-slider-is-lazy"),
            lazyloadSelector: ".wpa-lazy-img"
        });
        this.slider_current = gallery.querySelector(".kmk-block-gallery-current");
        this.slider_left = gallery.querySelector(".kmk-block-gallery-left")
        this.slider_left_btn = gallery.querySelector(".kmk-block-gallery-left-btn");
        this.slider_right = gallery.querySelector(".kmk-block-gallery-right")
        this.slider_right_btn = gallery.querySelector(".kmk-block-gallery-right-btn");
...
document.addEventListener('DOMContentLoaded', function() {
    const block_gallery = document.querySelector(".kmk-block-gallery");
