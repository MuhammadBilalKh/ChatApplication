                        ...
                        <div id="whats-new-content">
                            <div id="whats-new-textarea" style="position: relative;">
                                ...
                                <div id="mentionSuggestions" class="mention-suggestions" style="display: none;">
                                    <ul class="mention-suggestions-list"></ul>
                                </div>
                            </div>
                        </div>
                ...
                <nav class="activity-type-navs main-navs bp-navs dir-navs " role="navigation" aria-label="Directory menu">
                    ...
                    <ul class="component-navigation activity-nav">
                        ...
                        <li id="activity-mentions" class="dynamic" data-bp-scope="mentions" data-bp-object="activity">
                            <a href="{{ route('users.show_favorite_posts') }}">
                                My Favorites
                                <span class="count"></span>
                            </a>
                        </li>
                        ...
                        <li id="activity-mentions" class="dynamic" data-bp-scope="mentions" data-bp-object="activity">
                            <a href="{{ route('users.show_friends_posts') }}">
                                My Friends
                                <span class="count"></span>
                            </a>
                        </li>
...
@push('script')
    <script>
        ...
        function loadPosts() {
            ...
            fetch(`{{ route('posts.load_friends_posts') }}?page=${page}`)
                .then(res => res.json())
                .then(data => {
                    if (data.html.trim() !== '') {
