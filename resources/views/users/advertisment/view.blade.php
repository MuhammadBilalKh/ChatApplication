        ...
        <div class="entry-content clearfix">
            ...
            @if (isset($packageData) && !empty($packageData))
                <div class="atw-mb-6">
                    <div class="mt-3">
                        <div>
                            <span class="atw-inline-block h4 atw-text-gray-700 atw-text-xl atw-font-bold atw-py-3">Featured
                                Advertisment Package</span>
                        </div>
                        <div class="atw-text-base">
                            <table class="table table-hovert table-striped table-borderless">
                                <thead>
                                    <tr>
                                        <th>Package Name</th>
                                    ...
                                    <tr>
                                        <th>Package Price</th>
                                        <td>$ {{ number_format($packageData->price) }}</td>
                                    </tr>
                                    <tr>
                                        <th>Package Duration</th>
                                        <td>{{ $packageData->duration_days }}</td>
                                    </tr>
                                </thead>
                            </table>
                        </div>
